...
## **Настройка** MoreLogin **для работы с Mango Proxy**

### **Шаг 1: Запустите** MoreLogin

1. Запустите приложение MoreLogin на вашем компьютере

### **Шаг 2: Перейдите к настройкам прокси**

1. В окне создания профиля найдите и откройте раздел "Прокси-сервер"
2. Нажмите “Добавить прокси”

![image.png](attachment:6fbf6416-c83c-4c1f-9b9b-94bd5a56f1a7:image.png)
...
![image.png](attachment:19a9d04c-52b0-4ab0-8d98-a04b396d306f:image.png)
...
![image.png](attachment:c7aa07e7-ed45-4196-b1c1-0d367ff5d893:image.png)
